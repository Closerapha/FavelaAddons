...
public class FavelaDebugger {
   ...
   public static void dumpEntities(Minecraft client) {
      if (client.level != null && client.player != null) {
         ...
         for(Entity entity : nearby) {
            ...
            ((Cluster)clusters.computeIfAbsent(identity, (key) -> new Cluster())).add(entity, FavelaDisplays.renderedPosition(entity), client);
            ...
            if (entity instanceof LivingEntity) {
               ...
               details.append(FavelaGear.describe(entity));
            }
            ...
            if (name != null) {
               ...
               if (FavelaGlyphs.isGlyphText(name)) {
                  details.append("\n        text: \"").append(FavelaGlyphs.decode(name)).append("\"");
               }
         ...
         int bars = 0;
         net.minecraft.client.gui.components.LerpingBossEvent active = FavelaBossHp.activeBar();
         ...
         summary.append(FavelaAutoWalls.diagnose(client)).append("\n");
         summary.append("=====================================");
         ...
         String saved = fileName != null ? " §7- summary copied, full dump in config/favelaaddons/debug/" + fileName : " §7- summary copied to clipboard";
   ...
   public static String identityOf(Entity entity, String typeId) {
      if (entity instanceof Display.ItemDisplay) {
         ...
         String gear = FavelaGear.model(entity);
   ...
   private static String labelOf(Entity entity) {
      ...
      if (name == null) {
         ...
         String clean = FavelaGlyphs.isGlyphText(name) ? FavelaGlyphs.decode(name) : FavelaAutoClicker.sanitize(name).trim();
         if (clean.isEmpty()) {
            return "";
         } else {
