...
public class FavelaModMenu implements ModMenuApi {
   ...
   public ConfigScreenFactory<?> getModConfigScreenFactory() {
      return (parent) -> {
         ...
         List<AbstractConfigListEntry> secMonolith = new ArrayList();
         secMonolith.add(entryBuilder.startBooleanToggle(Component.literal("Monolith Tracker"), Config.monolith).setDefaultValue(true).setTooltip(new Component[]{Component.literal("Follows the Arcanist monolith while it is up.")}).setSaveConsumer((newValue) -> Config.monolith = newValue).build());
         secMonolith.add(entryBuilder.startBooleanToggle(Component.literal("Active Indicator"), Config.monolithHud).setDefaultValue(true).setTooltip(new Component[]{Component.literal("Names which monolith is the one in use right now.")}).setSaveConsumer((newValue) -> Config.monolithHud = newValue).build());
         secMonolith.add(entryBuilder.startStrField(Component.literal("Models"), Config.monolithModels).setDefaultValue("arcanist_orb").setTooltip(new Component[]{Component.literal("Model names that identify the monolith, comma separated.")}).setSaveConsumer((newValue) -> Config.monolithModels = newValue).build());
         secMonolith.add(entryBuilder.startBooleanToggle(Component.literal("Distance Readout"), Config.monolithDistance).setDefaultValue(true).setTooltip(new Component[]{Component.literal("Shows how far you are from the offensive monolith,"), Component.literal("under your feet on screen.")}).setSaveConsumer((newValue) -> Config.monolithDistance = newValue).build());
         secMonolith.add(entryBuilder.startIntField(Component.literal("Distance Drop"), Config.monolithDistanceDrop).setDefaultValue(20).setTooltip(new Component[]{Component.literal("Pixels below the middle of the screen.")}).setSaveConsumer((newValue) -> Config.monolithDistanceDrop = newValue).build());
         secMonolith.add(entryBuilder.startFloatField(Component.literal("Distance Scale"), Config.monolithDistanceScale).setDefaultValue(1.0F).setSaveConsumer((newValue) -> Config.monolithDistanceScale = newValue).build());
         secMonolith.add(entryBuilder.startStrField(Component.literal("Attack Text"), Config.monolithAttackText).setDefaultValue("Attack").setTooltip(new Component[]{Component.literal("Shown while the monolith core glows blue.")}).setSaveConsumer((newValue) -> Config.monolithAttackText = newValue).build());
         secMonolith.add(entryBuilder.startStrField(Component.literal("Vitality Text"), Config.monolithVitalityText).setDefaultValue("Vitality").setTooltip(new Component[]{Component.literal("Shown while the monolith core glows pink.")}).setSaveConsumer((newValue) -> Config.monolithVitalityText = newValue).build());
         secMonolith.add(entryBuilder.startIntField(Component.literal("Readout X"), Config.monolithX).setDefaultValue(10).setSaveConsumer((newValue) -> Config.monolithX = newValue).build());
         secMonolith.add(entryBuilder.startIntField(Component.literal("Readout Y"), Config.monolithY).setDefaultValue(120).setSaveConsumer((newValue) -> Config.monolithY = newValue).build());
         secMonolith.add(entryBuilder.startFloatField(Component.literal("Readout Scale"), Config.monolithScale).setDefaultValue(1.2F).setSaveConsumer((newValue) -> Config.monolithScale = newValue).build());
         qol.addEntry(entryBuilder.startSubCategory(Component.literal("Monolith"), secMonolith).setExpanded(false).build());
