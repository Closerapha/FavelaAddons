...
public class FavelaModMenu implements ModMenuApi {
   ...
   public ConfigScreenFactory<?> getModConfigScreenFactory() {
      return (parent) -> {
         ...
         secMonolith.add(entryBuilder.startBooleanToggle(Component.literal("Teleport Alert"), Config.monolithTeleport).setDefaultValue(true).setTooltip(new Component[]{Component.literal("Warns you on screen once the offensive monolith"), Component.literal("drifts past the distance below.")}).setSaveConsumer((newValue) -> Config.monolithTeleport = newValue).build());
         secMonolith.add(entryBuilder.startIntField(Component.literal("Teleport Distance"), Config.monolithTeleportAt).setDefaultValue(20).setMin(1).setMax(128).setSaveConsumer((newValue) -> Config.monolithTeleportAt = newValue).build());
         secMonolith.add(entryBuilder.startStrField(Component.literal("Teleport Text"), Config.monolithTeleportText).setDefaultValue("Teleport").setSaveConsumer((newValue) -> Config.monolithTeleportText = newValue).build());
         secMonolith.add(entryBuilder.startBooleanToggle(Component.literal("Distance In Blocks"), Config.monolithBlocks).setDefaultValue(false).setTooltip(new Component[]{Component.literal("Off reads 10.2m, on reads 10.2 blocks.")}).setSaveConsumer((newValue) -> Config.monolithBlocks = newValue).build());
