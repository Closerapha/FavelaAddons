...
public class FavelaModMenu implements ModMenuApi {
   ...
   private static void applyAndReopen(Screen parent, List<SetupBinding> bindings, Runnable change) {
      ...
      client.setScreen((new FavelaModMenu()).getModConfigScreenFactory().create(parent));
   }
   ...
   public ConfigScreenFactory<?> getModConfigScreenFactory() {
      return (parent) -> {
         ...
         assists.addEntry(new FavelaButtonEntry(Component.literal("Setups"), Component.literal("+ Add Setup"), () -> {
         ...
         for(Config.ArmorSetup setup : Config.armorSetups) {
            ...
            setupEntries.add(new FavelaButtonEntry(Component.literal("Remove"), Component.literal("Remove This Setup"), () -> {
