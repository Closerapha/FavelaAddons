...
public class FavelaModMenu implements ModMenuApi {
   ...
   public ConfigScreenFactory<?> getModConfigScreenFactory() {
      return (parent) -> {
         ...
         secMonolith.add(entryBuilder.startBooleanToggle(Component.literal("Range Ring"), Config.monolithRing).setDefaultValue(true).setTooltip(new Component[]{Component.literal("Draws the radius on the ground around each monolith.")}).setSaveConsumer((newValue) -> Config.monolithRing = newValue).build());
         secMonolith.add(entryBuilder.startBooleanToggle(Component.literal("Stat Readout"), Config.monolithHud).setDefaultValue(true).setTooltip(new Component[]{Component.literal("Shows time alive and the stats each monolith is granting.")}).setSaveConsumer((newValue) -> Config.monolithHud = newValue).build());
         secMonolith.add(entryBuilder.startBooleanToggle(Component.literal("Tempered Power"), Config.monolithTempered).setDefaultValue(false).setTooltip(new Component[]{Component.literal("Turn on if you converted attack into vitality."), Component.literal("The readout then shows vitality at half value.")}).setSaveConsumer((newValue) -> Config.monolithTempered = newValue).build());
         secMonolith.add(entryBuilder.startIntField(Component.literal("Radius"), Config.monolithRadius).setDefaultValue(6).setMin(1).setMax(32).setTooltip(new Component[]{Component.literal("Blocks. The ability reads 6.")}).setSaveConsumer((newValue) -> Config.monolithRadius = newValue).build());
         ...
         secMonolith.add(entryBuilder.startColorField(Component.literal("Ring Colour"), Config.monolithColor).setDefaultValue(10131967).setSaveConsumer((newValue) -> Config.monolithColor = newValue).build());
