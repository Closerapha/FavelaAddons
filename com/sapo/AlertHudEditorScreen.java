...
public class AlertHudEditorScreen extends Screen {
   ...
   public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
      ...
      if (Config.bossHp) {
         String bossText = SapoBossHp.format(0.853F);
         ...
         graphics.text(this.font, bossText, 0, 0, SapoBossHp.colorFor(0.853F) | -16777216, true);
   ...
   public boolean mouseClicked(MouseButtonEvent event, boolean bl) {
      ...
      if (button == 0) {
         ...
         if (Config.bossHp) {
            ...
            int bossW = this.font.width(SapoBossHp.format(0.853F));
            Objects.requireNonNull(this.font);
   ...
   public boolean mouseDragged(MouseButtonEvent event, double dragX, double dragY) {
      ...
      if (this.isDraggingAliveOrDead) {
         ...
         int proposedX = (int)(mouseX - this.dragOffsetX);
         Config.bossHpX = this.snapX(proposedX, this.font.width(SapoBossHp.format(0.853F)), Config.bossHpScale);
