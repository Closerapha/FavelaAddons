...
public class Sapo {
   ...
   private static final KeyMapping.Category CATEGORY_SAPO = Category.register(Identifier.parse("sapo:sapo"));

   public static void registrar() {
      toggleKey = KeyMappingHelper.registerKeyMapping(new KeyMapping("Toggle Sapo", Type.KEYSYM, 86, CATEGORY_SAPO));
