...
public class SapoBossHp {
   ...
   public static void registrar() {
      ClientTickEvents.END_CLIENT_TICK.register(SapoBossHp::onTick);
      HudElementRegistry.addLast(Identifier.parse("sapo:boss_hp"), SapoBossHp::render);
   }
   ...
   public static LerpingBossEvent activeBar() {
      List<LerpingBossEvent> bars = new ArrayList(SapoCalls.bossBars());
      if (bars.isEmpty()) {
         return null;
      } else {
